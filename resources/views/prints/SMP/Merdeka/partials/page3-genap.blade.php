{{-- PAGE 3: Rapor Semester Genap (stitch6) --}}
<div class="a4-page page3">
    ...
    <div class="p3-info">
        <div class="p3-info-grid">
            ...
            <div class="p3-info-right">
                <span style="white-space:nowrap;width:120px;padding-right:0.25rem">Semester</span><span class="colon-align">:</span><span class="font-bold" style="margin-left:0.25rem">II (dua) / Genap</span>
    ...
    <table class="p3-table">
        <tr>
            <th style="width:2rem">NO</th><th style="width:35%">MATA PELAJARAN</th>
            <th style="width:8%">NILAI<br>AKHIR</th><th>CAPAIAN PEMBELAJARAN</th><th style="width:8%">KKTP</th>
        </tr>
    ...
    {{-- Footer: KENAIKAN + KETIDAKHADIRAN + TTD --}}
    <table class="p3-table" style="margin-top:0">
        <tr>
            <td class="p3-footer-bg" style="width:15%;text-transform:uppercase">KENAIKAN</td>
            <td style="width:20%;text-align:left;padding:0.25rem 0.5rem;vertical-align:top">
                <div class="font-bold">Keputusan :</div>
                <div style="line-height:1.375;margin-top:0.25rem;position:relative;padding-bottom:0.25rem">Berdasarkan capaian pembelajaran pada semester 1 dan 2 peserta didik ditetapkan</div>
            </td>
            <td style="width:25%;text-align:left;padding:0.25rem 0.5rem;vertical-align:top">
                <div class="font-bold text-center" style="margin-bottom:1rem">Naik/Tidak Naik</div>
                <div style="display:flex;align-items:end;margin-bottom:0.25rem"><span style="white-space:nowrap">Ke Kelas</span><span style="margin-left:0.25rem">:</span><div class="dotted-line" style="height:0.75rem"></div></div>
                <div style="display:flex;align-items:end"><span style="white-space:nowrap">Tanggal</span><span style="margin-left:0.375rem">:</span><div class="dotted-line" style="height:0.75rem"></div></div>
            </td>
            <td rowspan="4" style="width:20%;vertical-align:top;padding-top:1rem">
                <div style="text-align:center;font-weight:bold">Mengetahui<br>Kepala Sekolah</div>
                <div style="margin-top:4rem;text-align:left;padding:0 0.5rem;font-weight:bold;display:flex;align-items:end"><span>NIP.</span><div style="border-bottom:1.5px solid black;flex-grow:1;margin-left:0.25rem;margin-bottom:0.25rem">{{ $lembaga->nip_kepala_sekolah ?? '' }}</div></div>
            </td>
            <td rowspan="4" style="width:20%;vertical-align:top;padding-top:1rem">
                <div style="text-align:center;font-weight:bold;margin-top:1rem">Wali Kelas</div>
                <div style="margin-top:4rem;text-align:left;padding:0 0.5rem;font-weight:bold;display:flex;align-items:end"><span>NIP.</span><div style="border-bottom:1.5px solid black;flex-grow:1;margin-left:0.25rem;margin-bottom:0.25rem">{{ $waliKelas->nip ?? '' }}</div></div>
            </td>
        </tr>
        <tr>
            <td rowspan="3" class="p3-footer-bg" style="text-transform:uppercase">KETIDAKHADIRAN</td>
            <td style="text-align:left;padding:0.25rem 0.5rem">1. Sakit</td>
            <td style="text-align:right !important;padding:0.25rem 0.5rem">{{ $attendanceSummary->sakit > 0 ? $attendanceSummary->sakit : '........' }} Hari</td>
        </tr>
        <tr>
            <td style="text-align:left !important;padding:0.25rem 0.5rem">2. Ijin</td>
            <td style="text-align:right !important;padding:0.25rem 0.5rem">{{ $attendanceSummary->ijin > 0 ? $attendanceSummary->ijin : '........' }} Hari</td>
        </tr>
        <tr>
            <td style="text-align:left !important;padding:0.25rem 0.5rem">3. Tanpa Keterangan</td>
            <td style="text-align:right !important;padding:0.25rem 0.5rem">{{ $attendanceSummary->alpha > 0 ? $attendanceSummary->alpha : '........' }} hari</td>
        </tr>
    </table>
</div>
