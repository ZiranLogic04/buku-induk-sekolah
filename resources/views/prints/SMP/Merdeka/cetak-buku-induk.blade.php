...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .colon-align { width: 12px; text-align: center; display: inline-block; flex-shrink: 0; }
        .text-center { text-align: center; }
        .font-bold { font-weight: 700; }

        /* ===== PAGE 1 STYLES (stitch3) ===== */
        ...
        .p1-w-label-main { width: 195px; flex-shrink: 0; }
        .p1-w-label-sub { width: 163px; flex-shrink: 0; }
        .p1-w-label-sub2 { width: 131px; flex-shrink: 0; }
        .p1-w-num { width: 2rem; flex-shrink: 0; }
